...
const KG_STYLE = [
  ...
  { selector: "node.component", style: { "background-color": "#5fb3ae", width: 10, height: 10 } },
  { selector: "node.net", style: { "background-color": "#c2b8a3", width: 6, height: 6 } },
  { selector: "node.net.power", style: { "background-color": "#d6857a" } },
  {
  ...
  { selector: "edge", style: { width: 0.6, "line-color": "#29332c", "curve-style": "haystack" } },
  { selector: "edge.grouped_into", style: { "line-color": "#384039", "line-style": "dashed", width: 0.5 } },
  { selector: "edge.power", style: { "line-color": "rgba(214,133,122,0.3)" } },
  { selector: "node:selected", style: { "border-width": 2.5, "border-color": "#e4e9e2" } },
